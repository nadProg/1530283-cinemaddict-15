import { getYear, getRuntime } from '../utils';
...
export const createFilmCardTemplate = (film) => {
  ...
  const { isWatched, isFavorite, isToWhatch } = userDetails;
  ...
  return `
    <article class="film-card">
      ...
      <div class="film-card__controls">
        <button class="film-card__controls-item film-card__controls-item--add-to-watchlist ${isToWhatch ? CONTROLS_ITEM_ACTIVE_CLASSNAME : ''}" type="button">Add to watchlist</button>
